...
public abstract class Vehicle2 {
    ...
    public Vehicle2(String ma, String mo, String vin, Date maDate, char t, float f) {
        manufacturer=ma;
        model=mo;
        vid=vin;
        manufDate=maDate;
    ...
    @Override
       public boolean equals(Object o) {
        if (o instanceof Vehicle2) {
            return (((Vehicle2) o).vid == null ? this.vid == null : ((Vehicle2) o).vid.equals(this.vid));
        } else {
            return false;
        }
    }
